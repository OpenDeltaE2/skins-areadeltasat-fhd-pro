# /usr/lib/enigma2/python/Components/Converter/AreaDeltasSatNetSpeedInfo.py
...
class AreaDeltasSatNetSpeedInfo(Poll, Converter, object):
	...
	def updateNetSpeedInfoStatus(self):
		...
		if self.type == self.RCL:
			return '%2.3f KB/s' % self.lanreceive
		elif self.type == self.TML:
			return '%2.3f KB/s' % self.lantransmit
		elif self.type == self.RCW:
			return '%2.3f KB/s' % self.wlanreceive
		elif self.type == self.TMW:
			return '%2.3f KB/s' % self.wlantransmit
			...
			return '%2.3f KB/s' % self.lanreceivemb
		elif self.type == self.TML_MB:
			return '%2.3f KB/s' % self.lantransmitmb
		elif self.type == self.RCW_MB:
			return '%2.3f KB/s' % self.wlanreceivemb
		elif self.type == self.TMW_MB:
			return '%2.3f KB/s' % self.wlantransmitmb
		elif self.type == self.RC:
			return 'Rx : %2.3f Mb/s' % self.receive
		elif self.type == self.TM:
			return 'Tx : %2.3f Mb/s' % self.transmit
			...
			return '%2.3f Mb/s' % self.receivemb
		elif self.type == self.TM_MB:
			return '%2.3f Mb/s' % self.transmitmb

...
# <widget render="AreaDeltasSatVolumeText" source="global.CurrentTime" position="42,9" size="200,22" font="Regular; 18" zPosition="3" backgroundColor="background" transparent="1" />
from Components.Renderer.Renderer import Renderer
from enigma import eLabel, eTimer, ePoint, eDVBVolumecontrol
from Components.VariableText import VariableText
from skin import parseColor

class AreaDeltasSatVolumeText(Renderer, VariableText):

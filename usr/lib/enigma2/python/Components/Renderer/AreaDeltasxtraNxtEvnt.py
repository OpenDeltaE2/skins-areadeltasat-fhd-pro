...
# for channellist,
# <widget source="ServiceEvent" render="DraxtraNxtEvnt" nxtEvents="4" snglEvent="" font="Regular; 18" position="840,500" size="400,110" zPosition="5" backgroundColor="background" transparent="1" />
...
class AreaDeltasxtraNxtEvnt(Renderer, VariableText):
